...
"""
This script first finds all people you follow and the people they follow. Among these people, it finds people who are often followed, but who you don't follow. This helps people discover who to follow.
...
try:
	...
	keys= f.read().split()
	f.close()
	print 'found keys in tconf: ' + `keys`
except:
	print 'you must put your consumer key,secret and access key,secret into file called tconf, in that order one per line'
	quit()
